...
class WebhookProcess(PlatformReporter):
    ...
    def __init__(self,**kwargs):
        ...
        PlatformReporter.__init__(self,
                step_func=step_func,
                **kwargs
                )
    ...
    def get_stepf_arn(self):
        ...
        """
        search_str = str(self.event_body['search_str'].strip())
        items = None

        for _ in range(24):
            try:
                query = self.db.table_runs.search_key("_id",
                                                      search_str)
                items = query["Items"]
            except Exception:
                items = []
    ...
    def _setup_github(self):
        ...
        self.github_repo = GitHubRepo(repo_name=self.webhook_info["repo_name"],
    ...
    def _chk_event(self):
        """
        {
            ...
            "action": "created",
            "pr_approved": null,
            "src_branch": "eks-change101",
            "dest_branch": "eks",
            "branch": "eks",
            "commit_hash": "21c4b3d6dba5c6c363f95f00f67fb5e4366d6323",
            "ssh_url": "git@github.com:williaumwu/iac-ci.git",
            "git_url": "git://github.com/williaumwu/iac-ci.git",
            "clone_url": "https://github.com/williaumwu/iac-ci.git"
        }
    ...
    def _get_github_webhook(self):
        """
        Parses the incoming GitHub webhook event from the request headers and event body,
        ...
        if event_type == "push": 
            ...
            #webhook_info.update(data["pull_request"])
            repo = _payload['repository']
    ...
    def _eval_iac_action(self):
        ...
        for action in actions:
            ...
            if self.iac_ci_info.get("require_approval") in [None,False,"false","None"]:
