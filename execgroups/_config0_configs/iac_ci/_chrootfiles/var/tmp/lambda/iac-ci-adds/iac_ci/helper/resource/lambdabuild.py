...
class LambdaParams(TFAwsBaseBuildParams):
    ...
    def __init__(self,**kwargs):
        ...
        TFAwsBaseBuildParams.__init__(self,
                                      **kwargs)
...
class Lambdabuild(LambdaParams):
    ...
    def _get_build_cmds(self):
        ...
        Raises:
            Exception: If method is not one of create/validate/ci/pre-create/check/apply/destroy
        """
        ...
        if self.method in ["create","apply"]:
            ...
            raise Exception("method needs to be create/validate/ci/pre-create/check/apply/destroy")
