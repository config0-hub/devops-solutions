...
class TFAppHelper:
    ...
    def __init__(self,**kwargs):
        ...
        # notice the execution directory is in "run" subdir
    ...
    def local_output_to_s3(self,srcfile=None,suffix=None,last_apply=None):
        ...
        Raises:
            Exception: If srcfile cannot be determined
        """
        ...
        if last_apply:
            ...
            cmds = [ f'aws s3 cp s3://$REMOTE_STATEFUL_BUCKET/$STATEFUL_ID/cur/{_filename} s3://$REMOTE_STATEFUL_BUCKET/$STATEFUL_ID/previous/{_filename} || echo "trouble copying file "{_filename}" in s3"',
                     f'aws s3 rm s3://$REMOTE_STATEFUL_BUCKET/$STATEFUL_ID/cur/{_filename} || echo "trouble removing file cur "{_filename}" in s3"',
    ...
    def s3_file_to_local(self,dstfile=None,suffix=None,last_apply=None):
        ...
        Raises:
            Exception: If dstfile cannot be determined
        """
